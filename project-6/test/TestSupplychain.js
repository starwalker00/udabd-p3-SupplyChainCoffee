...
contract('SupplyChain', function(accounts) {
    ...
    const originFarmLatitude = "5"
    const originFarmLongitude = "5"
    var productID = sku + upc
    const productNotes = "5Best beans for Espresso"
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        assert.equal(errorThrowned, true, 'Does not prevent duplication') 
    })    
